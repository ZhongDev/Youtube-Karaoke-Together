...
const Contact = () => {
  ...
  const ContactCard = ({ icon, title, description }) => (
    <Paper
      elevation={2}
      sx={{ p: 3, mb: 2, borderLeft: 4, borderColor: "primary.main" }}
    >
    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <Paper elevation={1} sx={{ p: 2, mb: 4, bgcolor: "info.light" }}>
        <Typography variant="body2" sx={{ color: "black" }}>
          <strong>Quick Note:</strong> For issues related to YouTube content,
          please refer to{" "}
          <Link
      ...
      <Paper elevation={1} sx={{ p: 2, mt: 3, bgcolor: "info.light" }}>
        <Typography variant="body2" sx={{ color: "black" }}>
          <strong>Important:</strong> By contacting us, you acknowledge that you
          have read our{" "}
          <Link
            onClick={() => navigate("/privacy-policy")}
