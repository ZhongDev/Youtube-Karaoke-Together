...
const TermsOfService = () => {
    ...
    const WarningBox = ({ children }) => (
        <Paper elevation={1} sx={{ p: 2, my: 2, bgcolor: 'warning.light', borderLeft: 4, borderColor: 'warning.main', color: 'black' }}>
        ...
        <Container maxWidth="md" sx={{ py: 4 }}>
            ...
            <HighlightBox>
                <Typography variant="body1" sx={{ fontWeight: 'bold' }}>
                    YouTube Terms of Service Binding: By using YouTube Karaoke Together, you agree to be bound by the{' '}
                    <Link href="https://www.youtube.com/t/terms" target="_blank" rel="noopener noreferrer" sx={{ color: '#1565c0' }}>
                        YouTube Terms of Service
                    </Link>. This application uses YouTube API Services and all YouTube content accessed through our
                    service is subject to YouTube's terms.
                </Typography>
            </HighlightBox>

            <Section title="1. Acceptance of Terms">
                <Typography paragraph>
                    By accessing or using YouTube Karaoke Together ("the Service"), you agree to be bound by these
            ...
            <Section title="2. YouTube API Services">
                <Typography paragraph>Our Service uses YouTube API Services to provide video search and playback functionality. By using our Service:</Typography>
                <List sx={{ pl: 4 }}>
                    <ListItem>
                    ...
                    <ListItem>• You understand that YouTube content accessed through our Service is subject to YouTube's policies</ListItem>
                    <ListItem>• You agree to comply with YouTube's Community Guidelines</ListItem>
                    <ListItem>• You acknowledge that YouTube may modify or discontinue API access at any time</ListItem>
                </List>
            </Section>
            ...
            <Section title="4. User Responsibilities">
                <Typography paragraph>As a user of our Service, you agree to:</Typography>
                <List sx={{ pl: 4 }}>
                    ...
                    <ListItem>• Comply with YouTube's Terms of Service and Community Guidelines</ListItem>
            ...
            <Section title="6. Privacy and Data">
                <Typography paragraph>
                    ...
                    <Link onClick={() => navigate('/privacy-policy')} sx={{ cursor: 'pointer', color: '#1565c0' }}>
                        Privacy Policy
                    </Link>, which explains how we collect, use, and protect your information. By using the Service,
                    you also consent to Google's data practices as outlined in the{' '}
            ...
            <Section title="7. Intellectual Property">
                <Typography paragraph>
                    The Service and its original content, features, and functionality are owned by YouTube Karaoke Together
                    and are protected by copyright, trademark, and other intellectual property laws. YouTube content accessed
                    through our Service remains the property of YouTube and its licensors.
                </Typography>
            </Section>
            ...
            <Section title="8. Disclaimers">
                <WarningBox>
                    <Typography variant="body1" sx={{ fontWeight: 'bold' }}>
                        Important: The Service is provided "as is" without warranties of any kind. We do not guarantee:
                    </Typography>
                    <List sx={{ mt: 1 }}>
            ...
            <Section title="9. Limitation of Liability">
                <Typography paragraph>
                    To the maximum extent permitted by law, YouTube Karaoke Together shall not be liable for any direct,
            ...
            <Section title="11. Contact Information">
                <Typography paragraph>For questions about these Terms of Service, please contact us:</Typography>
                <List sx={{ pl: 4 }}>
            ...
            <WarningBox>
                <Typography variant="body1" sx={{ fontWeight: 'bold' }}>
                    Acknowledgment: By using YouTube Karaoke Together, you acknowledge that you have read, understood,
                    and agree to be bound by these Terms of Service and the YouTube Terms of Service.
                </Typography>
            </WarningBox>
        </Container>
    );
